    ...
    public partial class AddingProductsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductThumbnailImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductThumbnailImage_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductThumbnailImage_ProductId",
                table: "ProductThumbnailImage",
                column: "ProductId");
        }
